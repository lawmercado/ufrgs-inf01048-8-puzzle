...
def __obter_caminho(nodo: Nodo) -> List[str]:
    """
...
def __busca_grafo(estado_incial: str, retira: Callable[[Deque[Nodo]], Tuple[Nodo, Deque[Nodo]]],
...
def bfs(estado: str) -> List[str]:
    ...
    return __busca_grafo(estado, retira)
